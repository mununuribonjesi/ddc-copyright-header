  ...
  const sections = [
    {
      ...
      content:
        " ddc-copyright-head is a tool for generating copyright & license header applying to the copyrightConfig.json file created in the root directory of your application.",
    },
    {
      header: "Synopsis",
      content: [
